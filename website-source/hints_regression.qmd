...
chart = {
  const height = 350;
  const labelMap = {
    class_3: "Class 3 Precision",
    class_4: "Class 4 Precision",
    class_3_r: "Class 3 Recall",
    class_4_r: "Class 4 Recall",
  };
...
const line = base.markLine().encode(
  vl.color().fieldN("Model").scale({
    domain: ['Standard XGBoost', 'Class Imbalance XGBoost (SMOTE)', 'Tuned XGBoost', 'Random Forest'],  // Adjust these categories based on your actual data
    range: ['#1E90FF', '#FFD700', '#32CD32', '#FF4500']
  }),
